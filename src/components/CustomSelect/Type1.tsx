...
const Type1 = ({ formikValues, formik, data, formikError, formikTouched, name, fieldLabel, optional, dropdownAlign }: Prop) => {
    ...
    return (
        <div className='relative'>
            ...
            {
                isRole &&
                <div className={`absolute z-[9999] ${dropdownAlign === "top" ? "bottom-14" : ""} bg-white mt-2 rounded-lg overflow-hidden w-[429px] flex flex-wrap justify-between shadow-bottom-light-blue-20 cursor-pointer`}>
