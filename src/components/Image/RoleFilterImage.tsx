  ...
  return (
    <>
      {role.toLowerCase() === "admin" ? (
        ...
        <img src={Icons.collector} alt="collector" className="w-6 h-6 filter grayscale " />
      ) : role.toLowerCase() === "audio checker" ? (
        <img src={Icons.audioChecker} alt="audioChecker" className="w-6 h-6 filter grayscale " />
      ) : role.toLowerCase() === "annotator" ? (
        <img src={Icons.annotator} alt="annotator" className="w-6 h-6 filter grayscale " />
        ...
        <img src={Icons.speakerMale} alt="speakerMale" className="w-6 h-6 filter grayscale " />
      ) : (
        ""
      )}
    </>
