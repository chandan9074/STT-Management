        ...
        <>
            {
                disabled ?
                    <button
                        ...
                        disabled
                        className={`bg-blue-gray-30 text-blue-gray-60 flex gap-2 items-center cursor-not-allowed
                    ...
                    : <button {...rest}
                        className={`flex gap-2 items-center ${variant === "Megenta" ? "border border-primary-ct-magenta-60" : variant === "CT-Blue" ? "border border-ct-blue-60" : "border border-ct-blue-30"}
