...
const Filter = (props: Props) => {
  ...
  return (
    <button
      {...rest}
      className={`py-2 px-2.5 bg-blue-gray-A10 flex items-center ml-2 relative duration-300 border-[1px] border-transparent ${count <= 0 ? "hover:rounded-[40px] hover:border-ct-blue-40 hover:bg-ct-blue-20 active:bg-ct-blue-30 rounded-[4px]" : "bg-ct-blue-60 rounded-[40px] hover:bg-ct-blue-70 active:bg-ct-blue-40"}`}
    >
