...
const Header = ({bgColor, type, targetColor, borderColor}: Props) => {
    return (
        <div className="relative">
            <div className={`${bgColor} w-full mt-20 flex justify-between rounded-t-xl p-6`}>
            ...
            <div className={` mx-6 border-dashed border-b-[2px] ${borderColor}`}></div>
            <p className={`${targetColor} bg-white w-fit py-1 px-2 absolute left-[42%] -bottom-[14px] rounded-[4px]`}>valid data
                start</p>
        </div>
