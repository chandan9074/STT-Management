    ...
    return (
        <div>
            ...
            {open ? (
                <>
                    <div
                        className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-[100] animate-fadeIn outline-none focus:outline-none"
                    >
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <img onClick={() => setOpen(false)} src={Icons.CloseIconButton} alt=""/>
                                    </div>
