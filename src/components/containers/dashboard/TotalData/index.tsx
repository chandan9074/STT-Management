    ...
    return (
        <div className="bg-white h-52 p-5">
            <div className="flex gap-5 items-end">
                ...
                <p className="text-small text-ct-blue-90-70% mb-1">Received : {totalDataCollection?.received}h</p>
            </div>
                ...
                <div className="w-[850px]">
                    ...
                    <div className='flex justify-between'>
                        <div className='flex gap-5 mt-3'>
                            <p className="text-small text-ct-blue-90-70% font-semibold">Total Valid : {totalDataCollection?.totalValid}h; </p>
                            <div className="flex gap-2 items-center">
                                <ClockCircleOutlined style={{ color: "#5F6B7D", fontSize: "12px" }} />
                                <p className="text-small text-ct-blue-90-70% ">Last Update: {totalDataCollection?.lastUpdate}</p>
                            </div>

                        </div>
                        <div>
                            <p className="mt-3 text-small font-semibold text-ct-blue-60">Total Target : {totalDataCollection?.totalTarget}</p>
                        </div>
                    </div>
                </div>
                <div className="">
