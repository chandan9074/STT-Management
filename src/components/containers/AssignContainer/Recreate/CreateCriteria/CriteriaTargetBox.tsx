          ...
          <div className="flex flex-col gap-x-3 items-start justify-start h-full w-full py-1 overflow-y-auto custom_scrollbar">
            ...
            <FormControl>
              <RadioGroup
                ...
                defaultValue={targetForRecreate[0].id}
              ...
              >
                {targetForRecreate?.map((criteria, index) => (
                  ...
                  >
                    <FormControlLabel value={criteria.id} sx={{ m: 0 }} control={<Radio size="small" onChange={() => selectCriteria(criteria)} />} label={<Typography sx={{ display: "none" }}>Criteria</Typography>} />
                    {/* </div> */}
