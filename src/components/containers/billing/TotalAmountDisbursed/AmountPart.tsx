    ...
    <>
      ...
      <div className="relative w-full h-52">
        <div className="absolute top-0 left-0 flex items-start">
          <h6
            className={`text-heading-6 font-medium text-ct-blue-10 ${totalAmount.length <= 6
                ? "mt-4"
          ...
          <h1
            className={`${totalAmount.length <= 6
                ? "text-[50px]"
                : totalAmount.length <= 8
                  ? "text-[40px]"
                  : totalAmount.length <= 11
        ...
        <div className="absolute flex w-full h-full top-0 left-0 justify-center items-start">
          <div className="w-1 h-48 rotate-[18deg] bg-gradient-to-b from-winter-wizard via-green-10 to-venetian-red" />
        </div>
        <div className="absolute bottom-3 right-0">
          <h6 className="text-base font-medium text-ct-blue-10">Total Valid</h6>
          <h1
            className={`${totalHours.length <= 5
                ? "text-[50px]"
                : totalHours.length <= 6
                  ? "text-[40px]"
