              ...
              <div
                ...
                className={` ${
                  isSttRoles === m.title
                    ...
                    : "text-[#5F7180] "
                } h-[41px] text-[16px] rounded-t-[15px] flex justify-center items-center gap-x-2 duration-500`}
              >
                {isSttRoles === m.title ? (
          ...
          <div className="grid grid-cols-4 gap-x-14">
            <div className="col-span-3 h-[140px]">
              <div className="flex justify-between">
                <h1 className="text-heading-6 text-ct-blue-45 font-semibold mb-[25px]">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <h1 className="text-xxs text-ct-blue-45">
                            {m.month.slice(0, 3)}
                          </h1>
                        </div>
                      </div>
