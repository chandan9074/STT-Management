...
const Header = () => {
  ...
  useEffect(() => {
    getAudioCheckerList("uploadAudioValidationSentenceChecker");
    getSpeakerList("uploadAudioValidationSentenceSpeaker");
    getAnnotatorList("uploadAudioValidationSentenceAnnotator");
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [])
  ...
  return (
    <div className='ml-6 mr-4 mb-5 flex items-center justify-between'>
      <div>
        <h1 className='text-heading-6 font-medium text-ct-blue-95 leading-6'>Sentence Validation</h1>
