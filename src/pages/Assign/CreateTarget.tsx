        ...
        <div className="bg-red-03 shadow-box pl-[24px] pt-[41px] pb-[24px] pr-[13px]">
          <div className="flex justify-between items-center mb-[23px] gap-x-3">
            <div className="flex items-center">
              <h1 className="text-blue-95 text-[18px] font-medium pr-3">
                Create Target
              </h1>
              <h2 className="text-ct-blue-90 text-[14px]">
                Create one or more target and assign
              </h2>
            </div>
            <div className="flex gap-x-[15px]">
              ...
              >
                <img
                  src={
                    dataShow ? Icons.DoubleArroDownDark : Icons.DoubleDarkICon
                  }
                  alt=""
