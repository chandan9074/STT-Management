...
export const checkingStatusUploadData = {
    total_data_size: 500,
    data: [
        {
            "id": "dasrtgb451",
...
export const annotatedFilesUploadData = {
    total_data_size: 500,
    data: [
        {
            "id": "1b25462v54546",
...
export const sentenceLevelValUpload = {
    total_data_size: 500,
    data: [
        {
...
export const ValidatedFilesUploadData = {
    total_data_size: 500,
    data: [
        {
            "id": "ughsdfiouwfhidu",
